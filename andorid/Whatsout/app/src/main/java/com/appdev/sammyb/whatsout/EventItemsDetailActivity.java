            ...
            btnSync.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v)
                {
                    ...
                    if(mEvent.gid == null) {
                        ...
                        updateUri = ContentUris.withAppendedId(CalendarContract.Events.CONTENT_URI,
                                Integer.parseInt(mEvent.gid) );
                        int rows = cr.update(updateUri, values, null, null);

                        Log.i("Event updated", "Rows updated: " + rows + "-"+ Integer.parseInt(mEvent.gid));

                        Toast toast = Toast.makeText(getApplicationContext(), "Event synced again!", Toast.LENGTH_SHORT);
                        toast.show();
                    }
